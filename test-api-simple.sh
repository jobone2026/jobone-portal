...
echo "=========================================="
curl -s -H "Authorization: Bearer $TOKEN" "$BASE_URL/categories" | jq '.'

echo ""
echo "=========================================="
echo "Test 2: GET /api/states"
echo "=========================================="
curl -s -H "Authorization: Bearer $TOKEN" "$BASE_URL/states" | jq '.'

echo ""
echo "=========================================="
echo "Test 3: GET /api/posts"
echo "=========================================="
curl -s -H "Authorization: Bearer $TOKEN" "$BASE_URL/posts?limit=2" | jq '.'
