...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div>
            ...
            <div class="space-y-4">
                @forelse ($posts->where('type', 'job')->take(25) as $post)
        ...
        <div>
            ...
            <div class="space-y-4">
                @forelse ($posts->where('type', 'result')->take(25) as $post)
                    <x-post-card :post="$post" />
                @empty
                    <div class="text-center py-8 text-gray-500">
                        <i class="fa-solid fa-inbox text-4xl mb-2 opacity-50"></i>
        ...
        <div>
            ...
            <div class="space-y-4">
                @forelse ($posts->where('type', 'admit_card')->take(25) as $post)
                    <x-post-card :post="$post" />
                @empty
                    <div class="text-center py-8 text-gray-500">
                        <i class="fa-solid fa-inbox text-4xl mb-2 opacity-50"></i>
        ...
        <div>
            ...
            <div class="space-y-4">
                @forelse ($posts->where('type', 'answer_key')->take(25) as $post)
                    <x-post-card :post="$post" />
                @empty
                    <div class="text-center py-8 text-gray-500">
                        <i class="fa-solid fa-inbox text-4xl mb-2 opacity-50"></i>
        ...
        <div>
            ...
            <div class="space-y-4">
                @forelse ($posts->where('type', 'syllabus')->take(25) as $post)
                    <x-post-card :post="$post" />
                @empty
                    <div class="text-center py-8 text-gray-500">
                        <i class="fa-solid fa-inbox text-4xl mb-2 opacity-50"></i>
        ...
        <div>
            ...
            <div class="space-y-4">
                @forelse ($posts->where('type', 'blog')->take(25) as $post)
                    <x-post-card :post="$post" />
                @empty
                    <div class="text-center py-8 text-gray-500">
                        <i class="fa-solid fa-inbox text-4xl mb-2 opacity-50"></i>
