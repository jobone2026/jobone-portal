...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 text-sm"><i class="fas fa-list"></i> Showing {{ $posts->count() }} posts</p>
    </div>
    ...
    @if ($posts->count() > 0)
        ...
        <div class="flex justify-between items-center mt-8 text-sm">
            ...
            @else
                <a href="{{ $posts->previousPageUrl() }}" class="text-blue-600 hover:text-blue-800 transition"><i class="fas fa-chevron-left"></i> Previous</a>
            @endif
            ...
            @if ($posts->hasMorePages())
                <a href="{{ $posts->nextPageUrl() }}" class="text-blue-600 hover:text-blue-800 transition">Next <i class="fas fa-chevron-right"></i></a>
            @else
