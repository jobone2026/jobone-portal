...
<div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="max-w-2xl w-full text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <a href="{{ route('posts.jobs') }}" class="p-6 bg-white border border-gray-200 rounded-lg hover:border-blue-600 hover:shadow-md transition">
            ...
            <a href="{{ route('posts.admit-cards') }}" class="p-6 bg-white border border-gray-200 rounded-lg hover:border-purple-600 hover:shadow-md transition">
            ...
            <a href="{{ route('posts.results') }}" class="p-6 bg-white border border-gray-200 rounded-lg hover:border-green-600 hover:shadow-md transition">
