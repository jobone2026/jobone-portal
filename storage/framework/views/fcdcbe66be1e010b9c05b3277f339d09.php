...
<?php $__env->startSection('title', 'Database Backup & Restore'); ?>
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="<?php echo e(route('admin.backups.create')); ?>" method="POST" onsubmit="return confirm('Create a new database backup?');">
                <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="<?php echo e(route('admin.backups.upload')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($backup['filename']); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <!-- Download -->
                                        <a href="<?php echo e(route('admin.backups.download', $backup['filename'])); ?>" 
                                        ...
                                        <!-- Restore -->
                                        <form action="<?php echo e(route('admin.backups.restore')); ?>" method="POST" class="inline" 
                                        ...
                                        <!-- Delete -->
                                        <form action="<?php echo e(route('admin.backups.delete', $backup['filename'])); ?>" method="POST" class="inline"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\job\govt-job-portal-new\resources\views/admin/backups/index.blade.php ENDPATH**/ ?>