    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-slate-900 text-white flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3">
                ...
                <a href="<?php echo e(route('admin.backups.index')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.backups.*') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800'); ?>">
