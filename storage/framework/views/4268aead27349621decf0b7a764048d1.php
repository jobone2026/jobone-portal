    ...
    <div class="flex items-center justify-between flex-wrap gap-3">
        <div class="flex items-center gap-2">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500"><?php echo e(url()->current()); ?></p>
            </div>
        </div>
        <div class="flex gap-1.5 flex-wrap">
            <!-- WhatsApp Share -->
            <a href="https://wa.me/?text=<?php echo e(urlencode(request()->getHost() . ' - ' . url()->current())); ?>" 
               target="_blank" 
               rel="noopener noreferrer"
               @click="typeof trackShare !== 'undefined' && trackShare('whatsapp', '<?php echo e(url()->current()); ?>', '<?php echo e($title ?? "Post"); ?>')"
            ...
            <!-- Telegram Share -->
            <a href="https://t.me/share/url?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode(request()->getHost())); ?>" 
               target="_blank" 
               rel="noopener noreferrer"
               @click="typeof trackShare !== 'undefined' && trackShare('telegram', '<?php echo e(url()->current()); ?>', '<?php echo e($title ?? "Post"); ?>')"
               class="inline-flex items-center justify-center w-7 h-7 rounded-full hover:scale-110 transition shadow-sm hover:shadow-md"
            ...
            <a href="https://instagram.com" 
               target="_blank" 
               rel="noopener noreferrer"
               @click="typeof trackShare !== 'undefined' && trackShare('instagram', '<?php echo e(url()->current()); ?>', '<?php echo e($title ?? "Post"); ?>')"
               class="inline-flex items-center justify-center w-7 h-7 rounded-full hover:scale-110 transition shadow-sm hover:shadow-md"
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" 
               target="_blank" 
               rel="noopener noreferrer"
               @click="typeof trackShare !== 'undefined' && trackShare('facebook', '<?php echo e(url()->current()); ?>', '<?php echo e($title ?? "Post"); ?>')"
               class="inline-flex items-center justify-center w-7 h-7 rounded-full hover:scale-110 transition shadow-sm hover:shadow-md"
            ...
            <!-- Twitter Share -->
            <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode(request()->getHost())); ?>" 
               target="_blank" 
               rel="noopener noreferrer"
               @click="typeof trackShare !== 'undefined' && trackShare('twitter', '<?php echo e(url()->current()); ?>', '<?php echo e($title ?? "Post"); ?>')"
               class="inline-flex items-center justify-center w-7 h-7 rounded-full hover:scale-110 transition shadow-sm hover:shadow-md"
...
<?php /**PATH C:\xampp\htdocs\job\govt-job-portal-new\resources\views/components/share-buttons.blade.php ENDPATH**/ ?>